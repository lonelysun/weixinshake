            ...
            else
            {
                ...
                else
                {
                    if(type==2)
                    {
                        ...
                        $(".common_alert")[0].style.cssText="  box-shadow: 0px 0px 8px 3px #999;width:220px;padding:15px;position: fixed;z-index:1005;top:40%;border-radius: 6px 6px;text-align: center;background-color: #fff;color:#2d2d2d;border:1px solid #999;word-break:break-all;";
