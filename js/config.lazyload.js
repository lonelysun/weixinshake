...
angular
		.module('app')
		/**
		 * jQuery plugin config use ui-jq directive , config the js and css
		 * files that required key: function name of the jQuery plugin value:
		 * array of the css js file located
		 */
		.constant(
				'JQ_CONFIG',
				{
		...
		.config(
				[ '$ocLazyLoadProvider', 'MODULE_CONFIG',
						function($ocLazyLoadProvider, MODULE_CONFIG) {
							// We configure ocLazyLoad to use the lib script.js
							// as the async loader
